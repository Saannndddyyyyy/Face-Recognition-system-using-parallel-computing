...
from fnc.parallelPool import pool_display_video, pool_face_localize, pool_verification
...
p3 = Process(target=pool_verification, args=(conn_31, conn_32, ft_path, threshold))
